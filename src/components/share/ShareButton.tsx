  ...
  return (
    <div className="flex items-center gap-4 flex-wrap" role="group" aria-label="Share options">
      ...
      <div className="flex items-center gap-4">
        <button type="button" onClick={handleCopy} className={iconButtonClass} aria-label="Copy link">
          {copied ? (
            <>
              <span className="sr-only" aria-live="polite">Copied</span>
              <svg className="w-4 h-4 flex-shrink-0 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden>
        ...
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className={iconLinkClass} aria-label="Share on WhatsApp">
        ...
        <a href={mailtoUrl} className={iconLinkClass} aria-label="Share by email">
          <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
