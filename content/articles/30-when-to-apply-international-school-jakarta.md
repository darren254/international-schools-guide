---
title: "When to Apply for International Schools in Jakarta | Timeline & Deadlines | The International Schools Guide"
slug: /insights/when-to-apply-international-school-jakarta
h1: "When to Apply for International Schools in Jakarta"
standfirst: "Timing matters. Apply too late and you are on a waiting list. Apply too early and some schools will not process your application. Here is the timeline."
meta_description: "When should you apply to international schools in Jakarta? Month-by-month timeline, key deadlines, and practical advice for every entry point. (155 chars)"
breadcrumbs: "Home > Insights > When to Apply for International Schools in Jakarta"
...
<!-- IMAGE PLACEHOLDER: Hero — Jakarta school entrance or admissions office -->
...
- [Entry points by school](#entry-points-by-school)
- [Mid-year applications](#mid-year-applications)
...
The biggest mistake families make with Jakarta school admissions is starting too late. The premium international schools — JIS, BSJ, ISJ, AIS — are not first-come-first-served at every year group. They have structured admissions rounds, assessment dates, and at the most popular entry points, waiting lists that can run a full year or more.

If you know you are moving to Jakarta, start the admissions process before you arrive. If you are already in Jakarta and want to switch schools, give yourself a full academic year of lead time where possible. This guide covers the timeline month by month.

## The Academic Year {#the-academic-year}

Most Jakarta international schools follow an August-to-June academic year, aligned with the Northern Hemisphere pattern.

| School | Academic Year | Term Structure |
|--------|--------------|----------------|
| JIS | August–June | Semester (2 terms) |
| BSJ | August–June | Trimester (3 terms) |
| ISJ | August–June | Trimester (3 terms) |
| NAS | August–June | Trimester (3 terms) |
...
<!-- IMAGE PLACEHOLDER: Timeline infographic -->

---

<!-- You might also be interested in -->
<!-- Related: #29 Questions to Ask on a School Tour, #34 Hardest Year Groups, #51 Relocating to Jakarta -->
...
For more on mid-year transfers, read our [guide to mid-year transfers between Jakarta international schools](#32).
