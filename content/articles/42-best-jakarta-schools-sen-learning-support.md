---
title: "Best Jakarta International Schools for SEN & Learning Support"
title_tag: "Best Jakarta International Schools for SEN & Learning Support | ISG"
meta_description: "Honest guide to SEN and learning support at Jakarta international schools. Which schools have genuine provision, what questions to ask, and when to look elsewhere."
slug: /insights/best-international-schools-jakarta-sen-learning-support
breadcrumbs: Home > Insights > Best Jakarta Schools for SEN
word_count: ~2000
schema: Article, BreadcrumbList, FAQPage
internal_links_to: "#1 hub, #24 curriculum, #12 fees, #36 SPK"
internal_links_from: "#1 hub, #51 relocating to Jakarta"
byline: Mia Windsor
---

# The Best Jakarta International Schools for SEN and Learning Support
...
**Do Jakarta international schools have to accept my child if they have an EHCP or IEP from another country?**
No. Jakarta international schools are private institutions operating outside any national framework that would oblige them to accept students with particular profiles. Bring any existing documentation — EHCPs, psychoeducational assessments, IEPs — to admissions conversations, but understand that acceptance is at the school's discretion.

**Will my child's existing IEP from our home country transfer directly?**
Not automatically, but it is valuable supporting evidence. Schools with proper SEN programmes will review it carefully and use it to develop a new plan appropriate to their context. Schools that don't engage seriously with existing documentation are worth questioning.

**Is SEN support charged separately from tuition?**
Often, yes. JIS's Learning Center programme has a separate published fee. Other schools may charge for specialist sessions or additional support hours. Always clarify this before accepting a place.

**My child needs speech therapy. Can they get this at school?**
Some schools — AIS most notably — have therapists available on-site. Others can facilitate sessions with external therapists who visit the campus. For families with children needing regular therapy, it is worth asking whether the school can coordinate with external providers or whether you will need to arrange everything independently.

**What does SEN support look like for secondary-age students in Jakarta?**
Options narrow at secondary level. Both AIS and JIS offer learning support into secondary — AIS through to IB Diploma, JIS through the Learning Center at secondary. For families arriving with a secondary-aged child who has significant needs, both schools are worth contacting directly to discuss current staffing and capacity.

---

*Internal links: [Best International Schools in Jakarta](#1) | [British vs IB vs American Curriculum](#24) | [Understanding International School Fees](#12) | [SPK Schools Explained](#36)*

---

*Schema to implement: Article, BreadcrumbList, FAQPage*
