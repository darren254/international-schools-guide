---
title: "IB Diploma Results at Jakarta International Schools | The International Schools Guide"
slug: /insights/ib-results-jakarta-international-schools
h1: "IB Diploma Results at Jakarta International Schools"
standfirst: "IB results are the single most requested data point parents ask about — and the one Jakarta's schools are least willing to share. Here is what we know."
meta_description: "Which Jakarta international schools publish IB Diploma results? Published averages, pass rates, and what the numbers mean for university admissions. (152 chars)"
breadcrumbs: "Home > Insights > IB Results Jakarta International Schools"
schema: Article, BreadcrumbList, FAQPage
internal_links_to:
  - "#39 University Destinations"
  - "#40 University Placement"
  - "#4 Best IB Schools in Jakarta"
...
<!-- IMAGE PLACEHOLDER: Hero — IB Diploma exam setting or student results day -->
...
- [Why results matter](#why-results-matter)
...
IB Diploma results are the closest thing international education has to a standardised measure. Every IB school worldwide sits the same exams, marked by the same examiners, against the same criteria. A 38 at BSJ means the same as a 38 at a school in London, Hong Kong or Geneva. That makes IB scores uniquely useful for comparing schools — which is exactly why so few schools publish them.
...
| School | Publishes IB Results? | Notes |
|--------|----------------------|-------|
| **BSJ** | Yes | Published on school website. Class of 2024: average 35, pass rate 97%. Class of 2025: average 34.7, 17% scoring 40+ |
| **Binus Simprug** | Yes | Published on school website. Average 34, pass rate 95%, perfect 45/45 scores in three consecutive years |
| **JIS** | No | Offers both AP and IB Diploma. Does not publish IB-specific averages. Publishes university destination data instead |
| **AIS** | No | Offers IB Diploma for Years 11–12. Does not publish results publicly |
| **ACG** | No | Offers IB Diploma. Does not publish results publicly |
| **NJIS** | No | Offers IB Diploma. Does not publish results publicly |
| **SPH** | No | Offers IB Diploma at Kemang Village and Lippo Village campuses. Does not publish results publicly |
| **GMIS** | No | Offers IB Diploma. Does not publish results publicly |
...
**Class of 2025:** Average score 34.7 points. 17% of the cohort scored 40 points or above — the threshold for competitive applications to Oxford, Cambridge, and equivalent universities worldwide.
